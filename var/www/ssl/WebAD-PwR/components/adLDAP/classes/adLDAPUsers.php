...
class adLDAPUsers {
    ...
    */
    ...
    /**
    *mod by Etheria Software
    *
    *
    * @param string $username The username to action against
    * @return bool
    */
       ...
       public function unlock($username) {
        ...
        if ($username === null) {
            return "Missing compulsory field ";
        }
        $userDn = $this->dn($username, false);
        if ($userDn === false) {
            return false;
        }
        $mod['lockoutTime'][0] = "0";
    ...
    *
    * @param string $username The username to action against
    * @parma string $email The recovery email address to set
    * @return bool
    */
      public function setrecoveyemail($username,$email) {
        if (!$this->adldap->getLdapBind()) {
            return false;
        }
        if ($username === null) {
        ...
        $mod['accountRecoveryEmail'][0] = $email;
        $result = @ldap_modify($this->adldap->getLdapConnection(), $userDn, $mod);
        if ($result == false) {
            return false;
        }
    ...
    *
    * @param string $username The username to action against
    * @parma string $email The recovery answers to set
    * @return bool
    */
      public function setrecoveyans($username,$answers) {
        if (!$this->adldap->getLdapBind()) {
            return false;
        }
        if ($username === null) {
        ...
        $mod['secretQuestionAnswerList'][0] = $answers;
        $result = @ldap_modify($this->adldap->getLdapConnection(), $userDn, $mod);
        if ($result == false) {
            return false;
        }
    ...
    *
    * @param string $username The username to action against
    * @parma string $email The recovery questions to set
    * @return bool
    */
      public function setrecoveyqs($username,$questions) {
        if (!$this->adldap->getLdapBind()) {
            return false;
        }
        if ($username === null) {
        ...
        $mod['secretQuestionList'][0] = $questions;
        $result = @ldap_modify($this->adldap->getLdapConnection(), $userDn, $mod);
        if ($result == false) {
            return false;
        }
